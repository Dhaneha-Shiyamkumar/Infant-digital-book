<?php
    ...
    if($_POST){
        ...
        if ($password==$cpassword){
            ...
            if($id2!=$id){
                ...
                $sql1="update patient set pemail='$email',pname='$name',ppassword='$password',ptel='$tele',pdob='$dob' where pid=$id;";
                $database->query($sql1);
    ...
    header("location: infants.php?action=edit&error=".$error."&id=".$id);
    ?>
